...
module.exports = HandleMsg = async (pakforlay, message) => {
            ...
            if (isOwnerBot) {
                await pakforlay.joinGroupViaLink(linkgrup)
                      .then(async () => {
                          ...
                          await pakforlay.sendText(chekgrup.id, `Hai minna~, Im LAC BOT. To find out the commands on this bot type ${prefix}menu`)
                      })
            } else {
        ...
        case 'stiker':
            if ((isMedia || isQuotedImage) && args.length === 0) {
                ...
                if (isMedia || isQuotedImage) {
                    ...
                    console.log(err)
	   	            await pakforlay.reply(from, 'Maaf batas penggunaan hari ini sudah mencapai maksimal ( Follow dulu instagram gw https://www.instagram.com/bknsr', id)
                    }
                }
                ...
                pakforlay.sendStickerfromUrl(from, url).then((r) => (!r && r !== undefined)
                    ...
                    : pakforlay.reply(from, 'GAUSAH MINTA BUAT STIKER KALAU GA FOLLOW IG SAYA 👊🙁 https://www.instagram.com/bknsr')).then(() => console.log(`Sticker Processed for ${processTime(t, moment())} Second`))
            } else {
        ...
        case 'stickergiphy':
            ...
            if (isGiphy) {
                ...
                pakforlay.sendGiphyAsSticker(from, smallGifUrl).then(() => {
                    pakforlay.reply(from, 'GAUSAH MINTA BUAT STIKER KALAU GA FOLLOW IG SAYA 👊🙁 https://www.instagram.com/bknsr')
                    console.log(`Sticker Processed for ${processTime(t, moment())} Second`)
                ...
                .catch(() => {
                    pakforlay.reply(from, `Ada yang error! (Follow dulu instagram gw 👊🙁 https://www.instagram.com/bknsr)`, id)
                })
            } else {
                await pakforlay.reply(from, 'Maaf, command sticker giphy hanya bisa menggunakan link dari giphy. [Giphy Only Ya BGST]', id)
            }
            break
        case 'meme':
            if ((isMedia || isQuotedImage) && args.length >= 2) {
                ...
                pakforlay.sendFile(from, ImageBase64, 'image.png', '', null, true)
                    ...
                    .catch(() => {
                        pakforlay.reply(from, 'Ada yang error! (Follow dulu instagram gw 👊🙁 https://www.instagram.com/bknsr)')
                    })
            } else {
        ...
        case 'quotemaker':
            ...
            if (qmaker.length >= 3) {
                ...
                try {
                    ...
                    pakforlay.sendFileFromUrl(from, `${hasilqmaker}`, '', 'Success kak!.. (Jangan Lupa Follow instagram gw 👊🙁 https://www.instagram.com/bknsr)', id)
                } catch {
                    pakforlay.reply('Yahh proses gagal, kakak isinya sudah benar belum?..', id)
                }
            } else {
                pakforlay.reply(from, `Pemakaian ${prefix}quotemaker |isi quote|author|theme\n\ncontoh: ${prefix}quotemaker |aku sayang kamu|-LACBOT|random\n\nuntuk theme nya pakai random ya kak..`)
            }
            break
        case 'nulis':
            ...
            await pakforlay.sendImage(from, `${nulisp}`, '', 'Success kak!.. (Jangan Lupa Follow instagram gw 👊🙁 https://www.instagram.com/bknsr)', id)
            .catch(() => {
	...
	case 'twimg':
		...
		case 'ig':
            ...
            await pakforlay.sendFileFromUrl(from, instag, 'Sukses mengunduh Foto/Video Instagram Menggunakan Bot WhatsApp LukBoT', '', id)
            .catch(() => {
                pakforlay.reply(from, 'Ada yang Error!', id)
            })
            break
		...
		case 'ytvid':
            ...
            await pakforlay.sendFileFromUrl(from, youtube, `Sukses mengunduh Video Youtube Menggunakan Bot WhatsApp LukBoT (Jangan Lupa Follow instagram gw 👊🙁 https://www.instagram.com/bknsr)`, id)
            .catch(() => {
        ...
        case 'anime':
            ...
            if (args[0] == 'random' || args[0] == 'waifu' || args[0] == 'husbu' || args[0] == 'neko') {
                ...
                .then(body => {
                    ...
                    pakforlay.sendFileFromUrl(from, randomnimex, '', 'Success kak.. (Jangan Lupa Follow instagram gw 👊🙁 https://www.instagram.com/bknsr)', id)
                })
                .catch(() => {
                    pakforlay.reply(from, 'Ada yang Error! (Jangan Lupa Follow instagram gw 👊🙁 https://www.instagram.com/bknsr)', id)
                })
        ...
        case 'resep':
            ...
            await pakforlay.reply(from, hasilresep + '\n\nIni kak resep makanannya kak.. (Jangan Lupa Follow instagram gw 👊🙁 https://www.instagram.com/bknsr)', id)
            .catch(() => {
                pakforlay.reply(from, 'Ada yang Error!', id)
            })
            break
		...
		*/
        ...
        case 'translate':
            ...
            translate(quoteText, args[0])
                ...
                .catch(() => pakforlay.sendText(from, 'Error, Kode bahasa salah. (Follow dulu instagram gw 👊🙁 https://www.instagram.com/bknsr)'))
            break
		case 'covidindo':
			rugaapi.covidindo()
			.then(async (res) => {
        ...
        case 'ceklokasi':
            ...
            if (zoneStatus.kode !== 200) pakforlay.sendText(from, 'Maaf, Terjadi error ketika memeriksa lokasi yang anda kirim. (Follow dulu instagram gw 👊🙁 https://www.instagram.com/bknsr)')
            let datax = ''
		...
		case 'klasmen':
            ...
            let textKlas = "*Klasemen Denda Sementara BoT LAC*\n"
            let i = 1;
            urut.forEach((klsmn) => {
	...
	/*	case 'simisimi':
        ...
        if (!isBotGroupAdmins) return pakforlay.reply(from, 'Gagal, silahkan tambahkan bot sebagai admin grup!', id)
            ...
            pakforlay.reply(from, 'Success kick all member kak (jangan lupa Follow dulu instagram gw 👊🙁 https://www.instagram.com/bknsr)', id)
        break
        ...
        case 'bc': //untuk broadcast atau promosi
            ...
            for (let idk of chatz) {
                ...
                if (!cvk.isReadOnly) pakforlay.sendText(idk, `〘 *L U L U K  B C* 〙\n\n${msg}`)
                if (cvk.isReadOnly) pakforlay.sendText(idk, `〘 *L U L U K  B C* 〙\n\n${msg}`)
            }
        ...
        case 'clearall': //menghapus seluruh pesan diakun bot
            if (!isOwnerBot) return pakforlay.reply(from, 'Perintah ini hanya untuk Owner bot ya, jika pengen jadi owner WA 089660728860', id)
